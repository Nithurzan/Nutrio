                    ...
                    <div className="flex flex-col items-center gap-2 min-w-[90px]">
                      <div className="flex items-center border rounded-lg bg-gray-50 dark:bg-gray-800 px-2 py-1 shadow">
                        ...
                        <button
                          className="px-2 text-lg font-bold text-gray-500 hover:text-primary dark:hover:text-blue-400"
                          onClick={() =>
                            updateQuanity(item._id, item.quanity + 1)
                          }
                        ...
                        <button
                          ...
                          title="Remove"
                        >
                          <FiTrash2 className="w-5 h-5 text-red-500 transition-transform duration-200 hover:rotate-45 hover:text-red-700" />
                        </button>
                      </div>
                    </div>
                  </div>
