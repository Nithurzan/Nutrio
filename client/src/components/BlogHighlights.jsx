...
const blogs = [
  {
    ...
    date: "May 2025",
    excerpt: "Discover quick and nutritious snacks to keep you energized throughout your busy day.",
    link: "#"
  },
  {
    id: 2,
    ...
    date: "April 2025",
    excerpt: "A simple guide to understanding organic labels and making better choices for your family.",
    link: "#"
  },
  {
    id: 3,
    ...
    date: "March 2025",
    excerpt: "Save time and eat healthy with these easy meal prep strategies for every lifestyle.",
    link: "#"
  }
];
...
const BlogHighlights = () => (
  <section className="my-20">
    <div className="text-center mb-10">
      <h2 className="text-3xl font-bold text-primary dark:text-secondary mb-2">Blog Highlights</h2>
      <p className="text-gray-500 dark:text-gray-400">Tips, guides, and inspiration from our experts</p>
    </div>
      ...
      {blogs.map(blog => (
        ...
        >
          ...
          <div className="flex-1 flex flex-col p-6">
            <span className="text-xs text-primary dark:text-secondary font-semibold uppercase mb-2">{blog.date}</span>
            <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">{blog.title}</h3>
