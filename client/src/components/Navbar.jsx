        ...
        >
            ...
            <div className='flex items-end justify-start text-2xl font-bold hover:scale-105 transition-transform duration-200'>
                <Link className='flex items-center gap-2' to='/'>
                    <img className='h-9 w-9 rounded-lg shadow' src={assets.logo} alt="Nutrio Logo" />
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="group relative">
                    <FaRegUser onClick={() => token ? null : navigate('/login')} className="text-4xl hover:text-white hover:bg-accent rounded-full p-2 duration-300 cursor-pointer dark:hover:bg-secondary shadow transition-transform hover:scale-110" />
                    {/* {dropdown menu} */}
                    {token &&
                        <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4 z-20">
                            <div className="flex flex-col gap-2 w-40 py-4 px-6 bg-white/90 dark:bg-gray-900/90 rounded-2xl shadow-2xl border border-primary/10 dark:border-secondary/20">
                                <p onClick={() => navigate('/profile')} className="cursor-pointer hover:text-primary dark:hover:text-secondary transition">My Profile</p>
                                <p onClick={() => navigate('/orders')} className="cursor-pointer hover:text-primary dark:hover:text-secondary transition">Orders</p>
                                <p onClick={logout} className="cursor-pointer hover:text-red-500 transition">Logout</p>
                            </div>
                        </div>}
                </div>
